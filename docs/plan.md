...
| 背景视频策略 | 第 1、2、3、7、12 章有专属视频；其余章节黑底，不用首屏视频占位 |
...
- [x] 第 2 章背景视频 `ch02.mp4`
- [x] 第 3 章背景视频 `ch03.mp4`
- [x] 第 7 章背景视频 `ch07.mp4`
- [x] 第 12 章背景视频 `ch12.mp4`
- [ ] 第 4–6、8–11、13–18 章专属背景视频（当前黑底，可选后续补充）
...
2. **第 4–6、8–11、13–18 章背景视频**：当前黑底可接受，补全后更新 `chapterVideoIds`
3. **角色语音**：18 段短音频（可选）

## 改进计划

- [ ] 将 `chapterVideoIds` 从当前 5 章扩展为全部 18 章就绪后批量开启
- [x] 章节进度指示与快速跳转（桌面端圆点导航 + 移动端进度提示）
...
- 已补入并接入 `ch02.mp4`、`ch03.mp4`、`ch12.mp4`，并将第 7 章视频路径统一为 `public/videos/ch07.mp4`。
